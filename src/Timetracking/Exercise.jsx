import Icon from '../assets/images/icon-exercise.svg'
import Dot from '../assets/images/icon-ellipsis.svg'
import Data from '../data.json'

function Exercise({ time }) {
    const times = Data.find(item => item.title === 'Exercise');
    ...
    return (
        <div className='bg-[var(--Lime-green-exercise)] relative rounded-2xl '>
            ...
            <div className='bg-[var(--Dark-blue)] p-8 absolute w-full top-12 rounded-2xl gap-4 flex flex-col text-white'>
                <div className='flex justify-between items-center'>
                    <h2>{times.title}</h2>
                    <img src={Dot} className='cursor-pointer' />
                </div>
