import Icon from '../assets/images/icon-social.svg'
import Dot from '../assets/images/icon-ellipsis.svg'
import Data from '../data.json'

function Social({time}) {
    const times = Data.find(item => item.title === 'Social');
    ...
    const timeLabels = {
        ...
        return (
            ...
            <div className='bg-[var(--Violet-social)] relative rounded-2xl '>
