import Icon from '../assets/images/icon-self-care.svg'
import Dot from '../assets/images/icon-ellipsis.svg'
import Data from '../data.json'

function Selfcare({time}) {
    const times = Data.find(item => item.title === 'Self Care');
    ...
    const timeLabels = {
        ...
        return (
            ...
            <div className='bg-[var(--Soft-orange-self-care)] relative rounded-2xl '>
